        ...
        <section className="mt-10">
          ...
          <div className="font-body text-gray-600 mt-4 space-y-4 text-base leading-relaxed">
            ...
            <p>
              ...
              contribute your own observations to assist in conservation
              efforts on our{" "}
              <a
            ...
            <p>
              ...
              highlight species that need more research or protection. The
              ranks that ORBIC produces are shared internationally through the{" "}
              <a
        ...
        <section className="mt-10">
          ...
          <div className="font-body text-gray-600 mt-4 space-y-4 text-base leading-relaxed">
            <p>
              ...
              of Natural Heritage Programs, utilizing their rigorous core
              standards and methodologies to assess status, risk, and condition
              of the state&apos;s biodiversity. We also work closely with
